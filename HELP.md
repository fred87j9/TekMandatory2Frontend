...
* The following dependency is not known to work with Spring Native: 'Rest Repositories'. As a result, your application
...
```
$ docker run --rm -p 8080:8080 TechProtocolFrontend:0.0.1-SNAPSHOT
```
